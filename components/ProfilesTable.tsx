    ...
    <div style={styles.page}>
      ...
      <div style={styles.bottomBar}>
        <button
          ...
          onMouseEnter={e => { if (page !== 0) { e.currentTarget.style.backgroundColor = '#2A2A2A'; e.currentTarget.style.color = '#fff' }}}
          onMouseLeave={e => { e.currentTarget.style.backgroundColor = 'transparent'; e.currentTarget.style.color = '#2A2A2A' }}
        >
          ← Prev
        </button>
        ...
        <button
          ...
          onMouseEnter={e => { if (profiles.length >= pageSize) { e.currentTarget.style.backgroundColor = '#2A2A2A'; e.currentTarget.style.color = '#fff' }}}
          onMouseLeave={e => { e.currentTarget.style.backgroundColor = 'transparent'; e.currentTarget.style.color = '#2A2A2A' }}
        >
          Next →
        </button>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  col:      { display: 'flex', alignItems: 'center', fontSize: 10, letterSpacing: '0.12em', textTransform: 'uppercase' as const, color: '#8A8A8A' },
  colName:  { flex: '0 0 30%' },
  ...
  emptyText: { fontSize: 12, color: '#C0C0C0', letterSpacing: '0.1em', textTransform: 'uppercase' as const },
